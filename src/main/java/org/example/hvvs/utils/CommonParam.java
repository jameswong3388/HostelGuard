...
public class CommonParam {
	...
	public static final String SESSION_ID = "SESSION_ID";				// Role type
	public static final String SESSION_EXPIRES_AT = "SESSION_EXPIRES_AT";				// Role type
	public static final String SESSION_LAST_UPDATE = "SESSION_LAST_UPDATE";				// Role type
